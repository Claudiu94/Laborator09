...
public interface Constants {
    ...
    final public static String USERNAME = "claudiu.zafiu";
    final public static String IDENTITY_IMPI =  "eimtest";
    final public static String IDENTITY_PASSWORD = "oh9ptkfKviPyaf5M";
    final public static String DOMAIN = "eimtest.onsip.com";
    final public static String NETWORK_PCSCF_HOST = "sip.onsip.com";
    final public static int NETWORK_PCSCF_PORT = 5060;
    final public static String NETWORK_REALM = "eimtest.onsip.com";
